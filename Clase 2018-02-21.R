...
x <- #Expresión incompleta, para salir de ella (dejar de ejecutar esa instrucción incompleta) puedes presionar ESC
...
#Cada objeto tiene sus propiedades o atributos los cuales se pueden accesar a partir de la función attributes()
...
as.logical(x)
as.complex(x)       
#Apareceran NA porque esa coerción no es posible y genera un valor faltante NA